...
"",{scores:b})}});var b=a._ensure_global("adroll_adv_id","adroll");this.add_script_element("https://init.blackcrow.ai/js/core/<ADV_EID>.js".replace("<ADV_EID>",b))})}};window.__adroll=window.__adroll||new __adroll__;
    ...
    __adroll__.prototype.render_advertisable_cell = function () {
        ...
        __adroll.segment_map = JSON.parse("{\"35RNAX2Y5JBJZDJUIEFJMG\":{\"child\":\"35RNAX2Y5JBJZDJUIEFJMG\",\"type\":\"s\"},\"3IDNE3ABDVDT7A3YMTNJ5C\":{\"child\":\"3IDNE3ABDVDT7A3YMTNJ5C\",\"type\":\"s\"},\"3ITARGHNMNCNHGKDHVECVP\":{\"child\":\"3ITARGHNMNCNHGKDHVECVP\",\"type\":\"s\"},\"4BOAL64DNRGJ3I4GK4JZV7\":{\"child\":\"4BOAL64DNRGJ3I4GK4JZV7\",\"type\":\"s\"},\"57ZSND3BOVDS7EKNCD56FY\":{\"child\":\"57ZSND3BOVDS7EKNCD56FY\",\"type\":\"s\"},\"6ZA53NLG2JAFZOSAF57EN6\":{\"child\":\"6ZA53NLG2JAFZOSAF57EN6\",\"type\":\"c\"},\"C2XUYDFRJVDANHSUNIHRFU\":{\"child\":\"C2XUYDFRJVDANHSUNIHRFU\",\"type\":\"c\"},\"DEV5TD3A4FFHXMHMJE7UYQ\":{\"child\":\"DEV5TD3A4FFHXMHMJE7UYQ\",\"type\":\"s\"},\"JFRAGRO3GJCO7KUHTZ2WET\":{\"child\":\"JFRAGRO3GJCO7KUHTZ2WET\",\"type\":\"p\"},\"JK7VKVVB4VAA5BA5RBQBHQ\":{\"child\":\"JK7VKVVB4VAA5BA5RBQBHQ\",\"type\":\"c\"},\"MO33WXK6EJCQ5HQ6XEYS55\":{\"child\":\"MO33WXK6EJCQ5HQ6XEYS55\",\"type\":\"s\"},\"TWVZURUWVRCE3GZT3OWRCO\":{\"child\":\"TWVZURUWVRCE3GZT3OWRCO\",\"type\":\"c\"}}");
...
rtb.innerHTML = ["/cm/b/out?advertisable=PV6ZEV5DP5BC3ITGKFYIEZ","/cm/g/out?advertisable=PV6ZEV5DP5BC3ITGKFYIEZ","/cm/index/out?advertisable=PV6ZEV5DP5BC3ITGKFYIEZ","/cm/l/out?advertisable=PV6ZEV5DP5BC3ITGKFYIEZ","/cm/n/out?advertisable=PV6ZEV5DP5BC3ITGKFYIEZ","/cm/o/out?advertisable=PV6ZEV5DP5BC3ITGKFYIEZ","/cm/outbrain/out?advertisable=PV6ZEV5DP5BC3ITGKFYIEZ","/cm/pubmatic/out?advertisable=PV6ZEV5DP5BC3ITGKFYIEZ","/cm/r/out?advertisable=PV6ZEV5DP5BC3ITGKFYIEZ","/cm/taboola/out?advertisable=PV6ZEV5DP5BC3ITGKFYIEZ","/cm/triplelift/out?advertisable=PV6ZEV5DP5BC3ITGKFYIEZ","/cm/x/out?advertisable=PV6ZEV5DP5BC3ITGKFYIEZ"].reduce(function (acc, cmURL) {
...
(function(){
  ...
  if (window === window.top && ua.indexOf('safari') !== -1 && ua.indexOf('chrome') === -1 && ua.indexOf('crios') === -1) {
    ...
    b.src = '//d.adroll.com/bounce/pre/PV6ZEV5DP5BC3ITGKFYIEZ/S7FOQRLVOND2LIYNNXLNFS/?d=' + encodeURIComponent('//s.adroll.com/j/bounce.js');
    ...
    if (__adroll.consent_allowed(__adroll.consent_networks.facebook)) {
        ...
        if (typeof __adroll.fb === 'undefined'){
            ...
            adrollFbqAsync(['init', '1904940279748168']);

            adrollFbqAsync(['set', 'autoConfig', 'false', '1904940279748168']);
            __adroll.fb=true;
            ...
            if (segment_type === "c") {
                ...
                if (!suppress_conversion) {
                    ...
                    var fb_track_src = "https://www.facebook.com/tr/?id=1904940279748168" +
                                      "&ev=Purchase" +
